...
<div style="width:100%; height:auto;">
   ...
   <!--header --><div style="height:120px; width:100%; background-color:#2F4F4F;border:0px solid #708090;">
  ...
  <!--menu--> <div style="height:45px; width:100%; background-color:#708090; border:0px solid #708090;">
...
<!--slider down data-->
            ...
            <div style="height:auto; width:1050px; margin:auto;   border:0px solid #000000; background-color:#FFFFFF; ">
                        ...
                        <div style="height:30px; width:1050px; border:0px solid #000000; color:#269FB2; font-size:18px; background-color:#DAD8D8;border-radius:5px; margin-top:10px; "><p style="margin-left:20px; margin-top:5px;"><b> </b></p></div>      
		...
		?>
                   ...
                   <td  style=" width:255px; border:0px solid #0000CC;"align="center" >
                    ...
                    <tr><td height="20"><strong>Price:&nbsp;</strong></td><td style="color:#FF0000; width:10px;">Tk. </td><td><?php echo $row['product_price'];?> </td></tr>
