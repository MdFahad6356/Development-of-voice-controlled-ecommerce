...
<!--slider down data-->
            ...
            <div style="height:auto; width:1050px; margin:auto;   border:0px solid #000000; background-color:#FFFFFF; ">
                        ...
                        <div style="height:30px; width:1050px; border:0px solid #000000; color:#269FB2; font-size:18px; background-color:#DAD8D8;border-radius:5px; margin-top:10px; "><p style="margin-left:20px; margin-top:5px;"><b> Search results</b></p></div>      
...
//$a="<script>document.writeln(p1);</script>";
			 ...
			 $query="select * from product where product_keyword like '%$search_query%' ";
