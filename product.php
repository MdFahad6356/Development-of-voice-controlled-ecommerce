...
<!--slider down data-->
        ...
        <?php
          ...
          <div style="border:10px solid #E0E0E0; width:100px; float:left;"><p align="center"><b>BDT</b><br>Tk. <?php echo $row['price'];?></p></div>



            <div style="border:10px solid #E0E0E0; width:100px; float:left;"><p align="center"><b>Offer Price</b><br>Tk. <?php echo $row['offer_price'];?></p></div>



             <div style="border:10px solid #E0E0E0; width:100px; float:left;"><p align="center"><b>You Save<br></b>Tk. <b style="color:#FF0000;"><?php echo $row['save'];?></b></p></div>
