...
<!--slider down data-->            
         ...
         <p align="center" style=" font-size:18px; color:black;"> &nbsp; Your Cart Details</p>
            ...
            <td width="200" align="center"><b>Price(Tk.)</b></td>
	      ...
	      ?>
            ...
            <td width="100" align="center"><?php echo $row['quantity'];?></td>
             ...
             <td width="200" align="center"><?php echo'Tk.'.$price;?></td>
...
$_SESSION['amt']=$amt;
      ...
      <td width="300" style="background-color:#FFFFFF;"></td>
       ...
       <td  width="200" align="center"><?php echo" <font color='#FF0000'> <b>Tk. </b></font>" .$amt;?></td>
