...
<!--logo-->
<div style="width:160px; height:120px; float:left; margin-left:0; border:0px solid #FFF;"><a href="index.php"></a></div>
<!--logo close-->
<!--right-->
...
<a href="index.php" style="text-decoration:none;color:#FFFFFF;">
	<input type="button" value="Home" style="border-radius:5px; background-color:#269FB2;; border:0px solid #0033FF;font:'Courier New', Courier, monospace'; height:22px; color:#FFFFFF;"></a>&nbsp;   &nbsp;
...
msg.pitch = 1; //0 to 2
/* msg.text = 'Welcome to Voice Commerce'+username; */
msg.lang = 'hi';
